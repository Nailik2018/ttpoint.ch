...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4">
            <a href="v1/sites/association/?association=sttv">
        ...
        <div class="col-md-4">
            <a href="v1/sites/association/?association=agtt">
        ...
        <div class="col-md-4">
            <a href="v1/sites/association/?association=anjtt">
    ...
    <div class="row">
        <div class="col-md-4">
            <a href="v1/sites/association/?association=attt">
            <div class="card white">
                <div class="card-body">
        ...
        <div class="col-md-4">
            <a href="v1/sites/association/?association=avvf">
                <div class="card light-gray">
                    <div class="card-body">
        ...
        <div class="col-md-4">
            <a href="v1/sites/association/?association=mttv">
            <div class="card white">
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-md-4">
            <a href="v1/sites/association/?association=nwttv">
            <div class="card light-gray">
                <div class="card-body">
        ...
        <div class="col-md-4">
            <a href="v1/sites/association/?association=ottv">
            <div class="card white">
                <div class="card-body">
        ...
        <div class="col-md-4">
            <a href="v1/sites/association/?association=ttvi">
            <div class="card light-gray">
                <div class="card-body">
